...
/**
 */
public class LFTomcat {
    private int port = 8080;
    private ServerSocket server;
    private Map<String, LFServlet> servletMapping = new HashMap<String, LFServlet>();
        ...
        try{
            ...
            for (Object k : webxml.keySet()) {
                ...
                if(key.endsWith(".url")){
                    ...
                    //单实例，多线程
                    LFServlet obj = (LFServlet)Class.forName(className).newInstance();
    ...
    public void start(){
        ...
        try {
            ...
            System.out.println("LF Tomcat 已启动，监听的端口是：" + this.port);
    ...
    private void process(Socket client) throws Exception {
        ...
        LFRequest request = new LFRequest(is);
        LFResponse response = new LFResponse(os);
